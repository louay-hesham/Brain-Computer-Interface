...
right_hand_mat = scipy.io.loadmat("right_hand_catherine.mat")
right_hand_data = right_hand_mat['emotiv_7sub_5class']

left_hand_mat = scipy.io.loadmat("left_hand_catherine.mat")
left_hand_data = left_hand_mat['emotiv_7sub_5class']

both_hands_mat = scipy.io.loadmat("both_hands_catherine.mat")
both_hands_data = both_hands_mat['emotiv_7sub_5class']    

both_feet_mat = scipy.io.loadmat("both_feet_catherine.mat")
both_feet_data = both_feet_mat['emotiv_7sub_5class']  

eye_closed_mat = scipy.io.loadmat("eye_closed_catherine.mat")
