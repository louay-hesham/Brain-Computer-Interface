...
right_hand_data = np.append(right_hand_data, right_hand_mat['emotiv_7sub_5class'], axis=0)


left_hand_mat = scipy.io.loadmat("recordings/Louay2/left_hand.mat")
left_hand_data = left_hand_mat['emotiv_7sub_5class']
left_hand_mat = scipy.io.loadmat("recordings/Louay2/left_hand.mat")
left_hand_data = np.append(left_hand_data, left_hand_mat['emotiv_7sub_5class'], axis=0)
...
# both_hands_data = np.append(both_hands_data, both_hands_mat['emotiv_7sub_5class'], axis=0)
...
# eye_closed_data = np.append(eye_closed_data, eye_closed_mat['emotiv_7sub_5class'], axis=0)
...
print(data.shape)
scipy.io.savemat("louay_left_right.mat", {'emotiv_7sub_5class':data})
